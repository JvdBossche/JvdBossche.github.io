...
function calculateSha1() {
  ...
  dt = Number(new Date);
  document.getElementById('ORDERID').value = document.getElementById('VKT_REFERENCE').value + "_" + dt;
...
function calculateUrl() {
  console.log("entered calculateUrl()");
...
function generateQr() {
  ...
  if (!elText.value) {
    console.log("De URL was nog niet gegenereerd!")
    alert("De URL is nog niet gegenereerd!");
    elText.value = "klik op de URL knop"
    elText.focus();
    return;
  } else {
    console.log("about to call qrcode.makeCode(\"" + elText.value + "\")")
